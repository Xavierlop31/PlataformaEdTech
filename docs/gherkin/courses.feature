...
Característica: Visibilidad y edición de cursos

  @RLS-C1 @EP-01
  Escenario: Un visitante anónimo ve los cursos publicados
  ...
  @RLS-C2 @EP-01 @EP-03
  Escenario: Un curso no publicado no es visible para nadie excepto su dueño
  ...
  @RLS-C3 @EP-04
  Escenario: Solo el instructor dueño puede editar su curso
  ...
  @RLS-C3 @EP-04 @EP-06
  Escenario: Editar un curso ajeno publicado da 403
  ...
  @RLS-C3 @EP-04 @EP-06
  Escenario: Editar un curso ajeno no publicado da 404, no 403
    Dado que existe un curso con is_published = false perteneciente al instructor A
    Cuando el instructor B (distinto de A) intenta PATCH /api/courses/:id sobre ese curso
    Entonces la respuesta es 404
  ...
  @RLS-C4 @EP-02
  Escenario: Solo un usuario con rol instructor puede crear un curso
  ...
  @RLS-C5
  Escenario: Solo el instructor dueño puede borrar su curso
  ...
  @RLS-C6 @EP-04
  Escenario: Publicar un curso sin lecciones es rechazado
  ...
  @EP-02
  Escenario: Crear un curso sin sesión devuelve 401
    Dado que no hay ninguna sesión autenticada
  ...
  @EP-04
  Escenario: Editar un curso inexistente devuelve 404
  ...
  @EP-02
  Escenario: Crear un curso con datos inválidos devuelve 400
    Dado que un usuario autenticado tiene profiles.role = 'instructor'
