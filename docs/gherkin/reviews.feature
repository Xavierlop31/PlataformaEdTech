...
Característica: Reviews de cursos

  @RLS-R1 @EP-10
  Escenario: Solo un estudiante inscrito puede crear una review
  ...
  @RLS-R2 @EP-09
  Escenario: Las reviews de un curso publicado son visibles públicamente
  ...
  @RLS-R3 @EP-14 @EP-15
  Escenario: Un estudiante solo puede editar o borrar su propia review
  ...
  @EP-14 @EP-15
  Escenario: Editar una review inexistente devuelve 404
  ...
  @RLS-R2 @EP-14 @EP-15
  Escenario: El autor puede leer y editar su propia review aunque el curso se despublique
  ...
  @RLS-R2 @EP-14 @EP-15
  Escenario: Editar la review de otro en un curso ya despublicado da 404, no 403
  ...
  @RLS-R4 @EP-10
  Escenario: Un estudiante no puede dejar más de una review por curso
  ...
  @RLS-R1 @EP-10
  Escenario: Un instructor no puede dejar una review, ni siquiera en un curso ajeno
  ...
  @EP-10
  Escenario: Dejar una review con rating fuera de rango devuelve 400
    Dado que el estudiante E está inscrito en el curso C
