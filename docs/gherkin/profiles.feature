...
Característica: Alta y gestión de perfiles

  @RLS-P3 @EP-16
  Escenario: Un usuario autenticado crea su perfil eligiendo su rol
  ...
  @RLS-P3 @EP-16
  Escenario: Crear un segundo perfil para el mismo usuario devuelve 409
  ...
  @EP-16
  Escenario: Crear un perfil con un rol inválido devuelve 400
    Dado que un usuario completó el signup OAuth y no tiene fila en profiles
  ...
  @RLS-P1 @EP-17
  Escenario: Un usuario sin perfil recibe 404 en /profiles/me
  ...
  @RLS-P1
  Escenario: Cualquiera puede leer el nombre y rol público de un perfil
  ...
  @RLS-P2 @EP-18
  Escenario: Un usuario solo puede editar su propio perfil
  ...
  @RLS-P2 @EP-18
  Escenario: El rol de un perfil es inmutable
